...
/**
 * General Kitchen Column
 *
 * Displays the top 3 active orders (FIFO) for the main kitchen line.
 * Auto-refreshes via socket invalidations and a 30s polling fallback.
 */
